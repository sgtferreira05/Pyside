...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menubar.setGeometry(QRect(0, 0, 599, 33))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineName.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Enter your name", None))
